...
1. `s2p <SVG Directory Full Path> <Width> <Height>` : It will convert the SVG files inside your provided directory with provided Width and Height. **All arguments are mandatory**. Example `eglu --tool design s2v /Users/anuranbarman/Documents/new_icons_anu/camera 512 512`
